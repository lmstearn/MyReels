...
type
  ...
  TOnRead = function(URL, Agent: AnsiString; Method: TReadMethod; Index, TotalSize, ReadSize, CurrentSize: {#BIG_INT};
...
function DwinsHs_GetRemoteSize(URL, Agent: AnsiString; Method: TReadMethod): {#BIG_INT};
var
...
function DwinsHs_ReadRemoteURL(URL, Agent: AnsiString; Method: TReadMethod; var Response: AnsiString;
...
procedure DwinsHs_AppendRemoteFile(Filename: string; URL, Agent: AnsiString; Method: TReadMethod; FileSize: {#BIG_INT});
var
  i, c: Integer;
  Finded: Boolean;
begin
